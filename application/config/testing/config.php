...
define("AUTH_SERVER",'http://192.168.1.224:6200/securityapi/v1.0/tokens/verify');
...
define("REDUCE_BONUS_API","http://192.168.1.234:8091/member_ship/bonus/returnBonus");
